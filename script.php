...
{
	protected $extension 	= 'com_phocafavicon';
	protected $updatetext 	= 'COM_PHOCAFAVICON_UPDATE_TEXT';
	protected $installtext 	= 'COM_PHOCAFAVICON_INSTALL_TEXT';
	protected $versiontext	= 'COM_PHOCAFAVICON_VERSION';
	protected $extensiontext= 'COM_PHOCAFAVICON';
	protected $configuretext= 'COM_PHOCAFAVICON_CONFIGURE';
