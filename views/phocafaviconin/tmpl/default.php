...
echo '<div id="j-main-container" class="span9">'
	...
	.'<h3>'.JText::_($this->t['l'].'_PHOCA_FAVICON').' - '. JText::_($this->t['l'].'_INFORMATION').'</h3>'
...
.'<a href="http://www.phoca.cz/documentation/" target="_blank">Phoca Favicon User Manual</a><br />'
